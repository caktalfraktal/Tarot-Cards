...
def redraw_celtic_cross(canvas, images):
    ...
    extra_horizontal_spacing_4_6 = 50
    extra_horizontal_offset_7_10 = 50
    total_width = (
...
def setup_main_gui(root, spread_type=None):
    ...
    window_width = total_width + 400
    window_height = card_height + 250
    ...
    text_box = tk.Text(text_frame, wrap="word", font=("Courier New", 10), width=38)
